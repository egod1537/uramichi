...
[codex] 2026-02-28 Chat 마크다운 제거 메모
- `ChatMessage.jsx`에서 `react-markdown`/`remark-gfm`/`rehype-highlight` 의존 렌더링을 제거하고, 메시지 본문을 일반 텍스트(`<p className="whitespace-pre-wrap break-words">`)로 출력하도록 변경함.
